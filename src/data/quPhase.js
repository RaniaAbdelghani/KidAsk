export default {
    "histoire-de-la-science": {
      slides: [
        {
          text: "Louis Pasteur est né en 1822. En 1865, il découvre un moyen de conserver plus longtemps les aliments : c'est la pasteurisation. Dans les années 1880, alors qu'il combattait le choléra chez les animaux, une idée brillante lui vient : introduire la maladie en petite quantité afin que l'organisme renforce sa capacité à se défendre. C'est le principe de la vaccination ! Il a testé ce principe avec un petit garçon avec la rage. En 1888, Pasteur ouvre un institut dédié à la vaccination et à la recherche.  ",
          image: "/pics-intervention-qa/Il était une fois les sciences/LouisPasteur.jpg",
          audio: "/audios/LouisPasteur.mp3",
          questions: [
            {
              starter: "Comment",
              options: [
                "Notre corps contient des cellules spéciales pour le protéger",
              ]
            },
            {
              starter: "C'est quoi / Qu'est ce que",
              options: [
                "Une maladie intestinale très contagieuse",
              ]
            },
            {
              starter: "Quelles sont",
              options: [
                "Il y a aussi la congélation par exemple",
              ]
            },
            {
              starter: "Où",
              options: [
                "L'institut Pasteur a été inauguré à Paris",
              ]
            },
            {
              starter: "Quel est le principe",
              options: [
                "Chauffer l'aliment puis le refroidir brusquement",
              ]
            }
          ]
        ...
        },
        {
          ...
          audio: "/audios/RosalindFranklin.mp3",
          questions: [
            {
            ...
            },
            {
              starter: "C'est quoi",
              options: [
                "Une particule qui enregistre les caractères spécifiques à être vivant",
              ]
            },
            {
              starter: "Pourquoi",
              options: [
                "Ils étaient en mauvais terme avec Rosalind",
              ]
            },
            {
              starter: "Qu'est ce qui a causé",
              options: [
        ...
        },
        {
          ...
          audio: "/audios/AlanTuring.mp3",
          questions: [
            {
              starter: "Pourquoi",
              options: [
                "Ces messages contenaient des secrets de guerre",
              ]
            },
            {
              starter: "Quand",
            ...
            },
            {
              starter: "Comment",
              options: [
                "Les premiers ordinateurs étaient des gros calculateurs électroniques",
              ]
            },
            {
              starter: "Qui",
              options: [
                "Les alliés ont remporté la deuxième guerre mondiale",
              ]
            },
          ]
        },
      ...
      slides: [
        {
          ...
          questions: [
            { 
              starter: "Quel",
              options: [
                "Elle peut enregistrer des informations",
              ]
            },
            {
              starter: "A quoi servent",
              options: [
                "Ils servent à détecter ce qui se passe dans l'environnement du robot",
              ]
            },
            {
              starter: "Comment",
            ...
            {
              starter: "Qu'est ce qui permet",
              options: [
                "Le moteur du robot lui permet de bouger",
              ]
            },
            {
              starter: "Comment fait un robot",
              options: [
                "Il analyse la langue qui est parlée pour pouvoir répondre",
              ]
            },
          ]
        },
          ...
          questions: [
            {
              starter: "Que veut dire",
              options: [
                "Interdire au robot de bouger",
              ]
            },
            {
              starter: "Que fait-on",
              options: [
                "Dans une centrale nucléaire, on produit de l'énergie",
              ]
            },
            {
              starter: "Quelle peut être l'origine",
              options: [
                "Une faute dans les calculs par exemple",
              ]
            },
            {
              starter: "Pourquoi",
              options: [
                "Ils peuvent causer des accidents graves",
              ]
            },
            {
              starter: "C'est quoi",
              options: [
                "Un système multiplié quatre fois",
              ]
            },
          ]
        },
        {
          ...
          audio: "/audios/robotevolution.mp3",
          questions: [
            {
              starter: "Qui",
              options: [
                "Ce sont les hommes qui contôlent les robots",
              ]
            },
            {
              starter: "Comment",
              options: [
                "Ils seront plus précis dans leurs calculs",
              ]
            },
            {
              starter: "Pourquoi",
              options: [
                "Car ils peuvent créer des accidents, sinon",
              ]
            },
            {
              starter: "Qu'utilisent",
              options: [
                "Elles utilisent la wifi pour communiquer",
              ]
            },
            {
              starter: "A quoi vont servir",
              options: [
                "A réduire la charge de travail des hommes",
              ]
            },
          ]
        }
    ...
    "monde-des-animaux": {
      slides: [
        ...
        },
        {
          starter: "A quoi sert",
          options:[
            "A motiver les abeilles qui ne travaillent pas",
          ]
        },
        {
          starter: "Que veut dire",
          options:[
            "C'est la vibration pour demander à manger",
          ]
        },
        ]
    },
    {
      text: "Le Mone de Campbell est un petit singe de Côte d'Ivoire. En langage mone, les alertes (hok) et (krak) indiquent la présence de leurs deux ennemis. Lorsqu'on ajoute un 'oo' à la fin, il faut comprendre cette fois 'danger dans les arbres': (hok-oo), et 'danger au sol': (krak-oo). Maintenant, combinez les krak-oo avec des boom, ça donne 'attention, chute de branches ou de troncs d'arbre!': (krak-oo-boom). Ils peuvent donc construire des phrases! Aussi, les mones émettent un autre son particulier quand quelqu'un qu'ils ne connaissent pas s'approche d'eux. C'est un cri d'alerte qui signale la présence d'un humain!",
          ...
          },
          {
            starter: "Pourquoi",
            options:[
              "Pour aller se cacher des ennemis",
            ]
          },
          {
            starter: "Qu'est ce que",
      ...
      },
        {
          ...
          audio: "/audios/parler aux animaux.mp3",
              ...
              {
                starter: "Qu'est ce qu'il faut faire",
                options:[
                  "Il faut observer les comportements des animaux",
                ]
              },
              {
                starter: "Qu'est ce qu'un",
                options:[
                  "Un appareil avec une technologie avancée",
                ]
              },
              {
                starter: "Que peut-on faire avec",
                options:[
                  "Entendre les sons sous l'eau par exemple",
                ]
              },
              {
                starter: "Pourquoi",
                options:[
                  "Car ces robots ressemblent à des animaux",
                ]
              },
              ]
          }
      ...
      slides: [
        ...
        text: "Une constellation est un ensemble d'étoiles qui représente une forme particulière. La plus célèbre est la constellation de la Grande Ourse; elle est composée d'étoiles très brillantes qui lui donnent la forme d'une casserole. La grande Ourse est très utile pour les marins. Bien que les étoiles formant une constellation semblent être proches les unes des autres, ce n'est en général pas le cas. Les étoiles sont tellement éloignées de nous que l'on perd toute idée de perspective. Il existe une carte du ciel qui indique toutes les constellations connues. ",
              ...
              },
              {
                starter: "Quand",
                options:[
                  "Pendant la nuit, si le ciel est clair",
                ]
              },
              {
                starter: "C'est quoi'",
                options:[
                  "Une carte qui montre les composantes du ciel",
                ]
              },
              {
                starter: "Où",
              ...
              },
              {
                starter: "Pourquoi",
                options:[
                  "Elle sert de repère aux marins s'ils ne pas de boussole",
                ]
              },
              ]
          },
            ...
            text: "Après plusieurs expériences, on pense comprendre les premiers moments de notre univers: il avait une taille microscopique et était extrêmement chaud. Il n'existait donc pas de galaxies, ni d'étoiles, ni de planètes, rien. Au commencement, tout d'un coup, un phénomène qui ressemble à une explosion s'est produit et a donné naissance à l'univers. On appelle cela le Big Bang. Cette explosion de chaleur était tellement importante qu'elle créa toute la matière de l'univers. Les éléments se fusionnaient petit à petit pour en créer des nouveaux: on parle d'une 'expansion de l'univers'.",
              ...
              audio: "/audios/bigbang.mp3",
                  ...
                  },
                  {
                    starter: "Quel",
                    options:[
                      "L'étoile émet de la lumière",
                    ]
                  },
                  {
                    starter: "Que veut dire",
                    options:[
                      "C'est l'augmentation de la taille de l'univers",
                    ]
                  },
                  ]
              },
                ...
                text: "L'astéroïde est un corps composé de roches et de métaux. Il est de taille variée et se déplace dans l'espace. Il ne fait partie ni des planètes, ni des étoiles. Sa taille peut varier de moins d'un centimètre à plusieurs centaines de kilomètres de diamètre. Le premier astéroïde a été découvert en 1801. Il y a 65 millions d'années, c'est un astéroïde de 14 kilomètres de diamètre qui s'est écrasé sur Terre. Il est en partie responsable de la disparition des dinosaures. Les astéroides peuvent donc être dangereux et il faut éviter leurs chocs avec la terre.",
                  ...
                  audio: "/audios/asteroide.mp3",
                      questions: [
                        ...
                        starter: "Comment",
                        options:[
                          "On les découvert par hasard",
                        ]
                      },
                      {
                        starter: "Pourquoi",
                        options:[
                          "Le choc avec la terre a détruit les habitats des dinosaures",
                        ]
                      },
                      {
                        starter: "Quelle est la probabilité",
                        options:[
                          "Le risque d'avoir un autre choc est très faible",
                        ]
                      },
                      {
                        starter: "Que peut-on faire",
                        options:[
                          "Il faut toujours observer les mouvements des astéroïdes",
                        ]
                      },
                      {
                        starter: "Que risque t-on si",
                        options:[
                          "les petits astérïdes ne sont pas dangereux",
                        ]
                      },
                      ]
                  },
    ...
    "proteger-nature": {
      slides: [
        {
          ...
          audio: "/audios/geothermie.mp3",
          questions: [
            {
            starter: "Comment",
            options:[
              "On creuse à 4000 mètres de profondeur pour arriver à 150 degrés",
            ]
          },
          {
            starter: "C'est quoi",
            options:[
              "C'est une énergie qui ne s'épuise pas",
            ]
          },
          {
            starter: "Quels sont",
            options:[
              "Il y'a les Etats-Unis et la France par exemple",
            ]
          },
          {
            starter: "Pourquoi",
          ...
          },
          {
            starter: "Quels sont",
            options:[
              "Elle est présente partout et son utilisation ne laisse pas de déchets",
            ]
          },
          ]
      }, 
      {
        ...
        {
          starter: "Quels sont les dangers",
          options:[
            "L'agriculture utilise des produits chmiques toxiques",
          ]
        },
        {
          starter: "Pourquoi",
        ...
        },
        {
          starter: "Comment",
          options:[
            "L'eau polluée contient des bactéries qui entraînent des maladies",
          ]
        },
        ]
    }, 
  
    {
      ...
      questions: [
        ...
        starter: "Pourquoi",
        options:[
          "La lumière perturbe la croissance des végétaux",
        ]
      },
      {
        starter: "Comment",
      ...
      },
      {
        starter: "Pourquoi",
        options:[
          "La lumière désoriente les oiseaux migrateurs",
        ]
      },
      {
        starter: "Que",
        options:[
          "La photopollution peut causer des troubles de sommeil",
        ]
      },
      ]
  }, 
      ...
      slides: [
        {
          ...
          },
          {
            starter: "Pourquoi",
            options:[
              "Pour protéger la femme si elle tombe",
            ]
          },
          {
            starter: "De quel pays",
            options:[
              "La Finlande",
            ]
          },
        ...
        }, 
        {
          ...
          questions: [
            ...
            starter: "Comment",
            options:[
              "On commence le jeu avec une partie d'échecs",
            ]
          },
          {
            starter: "Qui",
          ...
          },
          {
            starter: "C'est quoi",
            options:[
              "C'est un jeu d'échecs qui ne doit pas dépasser 4 minutes",
            ]
          },
          {
            starter: "Combien",
            options:[
              "Il y a 11 tours au total",
            ]
          },
          {
            starter: "Comment",
        ...
        },
        {
          ...
          questions: [
            ...
            starter: "Pourquoi",
            options:[
              "Le fluorescent est visible sous l'eau",
            ]
          },
          {
            starter: "Comment",
          ...
          },
          {
            starter: "Combien",
            options:[
              "Il y a six joueurs par équipe",
            ]
          },
          {
            starter: "Pourquoi",
            options:[
              "Il faut un arbitre sous l'eau et un autre dehors",
            ]
          },
          {
            starter: "Où",
